...
**به‌روزرسانی ۲۰۲۶-۰۸-۲۸ — آخرین سرنخ TA هم بسته شد:** تنها استثنای امیدوارکننده، ادج «ADX trend-strength روی 1d» بود که در [provider-edge-htf-experiment-plan.md](./provider-edge-htf-experiment-plan.md) §9 روی ۵۶۵ کندل (۲۰۲۵–۲۰۲۶) در کل همسایگی پارامتر پایدار به نظر می‌رسید. با برگشتن دسترسی شبکه، همان sweep روی کل تاریخچه‌ی ۹ساله‌ی Binance (۲۰۱۷-۰۸ تا ۲۰۲۶-۰۸، BTC **و** ETH) دوباره اجرا شد (§10): روی هر دو نماد **۰ keep، و train در تمام ترکیب‌ها منفی**. یافته‌ی §9 یک artifact پنجره‌ی ۱۸ماهه بود. جمع‌بندی نهایی: **TA کلاسیک روی BTC/USDT و ETH/USDT در 1h/4h/1d با مدل fill/fee واقعی به‌عنوان منبع ادج تمام‌شده است** — گام بعدی تغییر کلاس فرضیه است (regime/volatility targeting یا فیچر غیر-TA مثل funding/basis/on-chain)، نه grid پارامتر دیگر.
